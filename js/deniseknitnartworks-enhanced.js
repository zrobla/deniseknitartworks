...
(function ($) {
  ...
  var supplement = {
    en: {
      ...
      hero_eyebrow: 'Hand-knit in the alps · Glarus, Switzerland',
      hero_title_main: 'Quiet rows, alpine light, and a',
      hero_title_script: 'second life',
      hero_lede: 'I am Denise — a knitter from Glarus. With time and quiet on my side, I now braid wool, breath and memories.',
      hero_paragraph: 'This knitting journal gathers my hand-knit pieces, the techniques I love, and the alpine palettes that guide my needles. Take your time, follow the threads, and feel free to write me.',
      hero_cta_gallery: 'Discover the gallery',
      hero_cta_atelier: 'See how I knit',
      hero_signature: 'Denise',
      hero_signature_role: 'Knitter in the alps',
      ...
      slide3_eyebrow: 'Knitting from Glarus · An invitation',
      slide3_title_main: 'Where wool becomes',
      slide3_title_script: 'memory',
      slide3_lede: 'In the heart of the Glarner Alps, my home gathers north light, a wood stove, and the slow rhythm of mountain mornings.',
      slide3_paragraph: 'Step inside to discover the four pillars of my craft and the quiet rituals I love to share. Or simply write me — I always answer.',
      slide3_cta_primary: 'See the craft',
      slide3_cta_secondary: 'Write to Denise',
      slide3_signature: 'Glarus',
      slide3_signature_role: 'An open home in the alps',
      bio_breadcrumb: 'About Denise',
      bio_eyebrow: 'The maker',
      bio_name_first: 'Denise',
      bio_name_last: 'Gillioz',
      bio_kicker: 'tricot de Glaris',
      bio_lede: 'A knitter from Glarus, Switzerland.',
      bio_manifesto: 'For many years, professional duties and family life often pulled my hands away from knitting. When retirement opened the door, I took things back in hand. I cast on a pair of socks. I have not put the needles down since.',
      bio_chap1_eyebrow: 'Chapter one',
      bio_chap1_title: 'A turning',
      bio_chap1_p1: 'A change came, the way changes often come — not with fanfare, but with an empty morning. I made tea, opened the shutters to the alpine cold, and looked for something to hold.',
      bio_chap1_p2: 'The needles came down from the attic — walnut, worn smooth by hands long before mine. I cast on twenty stitches and did not look up until lunchtime. Something in me had been waiting for this quiet.',
      bio_chap2_eyebrow: 'Chapter two',
      bio_chap2_title: 'Meeting wool',
      bio_chap2_p1: 'I had knitted before — scarves for my family, a cardigan once. But meeting wool with time on your side is not the same as meeting it as a hurried Sunday hobby.',
      bio_chap2_p2: 'I read; I listened to spinners; I drove to small alpine farms where women taught me how merino fibres want to be held, why baby alpaca lies down and merino springs up, what kid mohair does to the light at six in the evening. The wool taught me patience. Patience taught me to design.',
      bio_chap3_eyebrow: 'Chapter three',
      bio_chap3_title: 'Where I knit today',
      bio_chap3_p1: 'I knit in our converted attic, north-facing, lit by snow on six months of the year. There is a wood stove I tend with care, a worktable from another time, and a vintage swift found at a flea market.',
      bio_chap3_p2: 'I knit between morning and evening, with a chamomile pause at noon. I host a monthly knit circle in Glarus; newcomers receive tea, a pattern, and a hand-written welcome.',
      bio_chap3_p3: 'I do not sell. I share. I post photographs because I love the alpine palette and want it to live somewhere besides my own eyes. This site is not a shop — it is an open home. Come in. Sit a while.',
      ...
      bio_signature_caption: 'Glarus · Switzerland',
      bio_cta_atelier: 'See how I knit',
      bio_cta_gallery: 'Browse the gallery',
      bio_cta_journal: 'Read the journal',

      atelier_open_diary: 'Open the knitting notes',
      ...
      parallax_cite: 'Denise · in the alpine quiet',
      scroll_cue: 'Discover',
      write_tooltip: 'Write to Denise',

      rhythm_eyebrow: 'A day in my knitting',
      rhythm_title: 'The rhythm of knitting',
      rhythm_lede: 'Glarus time, alpine seasons. My knitting breathes to its own rhythm — here is what is happening right now.',
      rhythm_phase_dawn: 'Denise lights the wood stove and opens the north window.',
      rhythm_phase_morning: 'Knitting hours · slow stitching by the cold morning light.',
      rhythm_phase_noon: 'Tea break with chamomile and alpine peaks watching.',
      ...
      rhythm_phase_night: 'The home sleeps under alpine stars.',

      diary_breadcrumb: 'Knitting notes',
      diary_eyebrow: 'A practice in fragments',
      diary_title: 'The knitting notes',
      diary_lede: 'Short notes from the attic — a yarn discovery, a sentence I underlined, an alpine sketch at dawn. No order, only weather.',
      ...
      diary_signature_caption: 'Knitting notes · updated when the light is right',
      diary_e1_date: 'A quiet morning',
      diary_e1_text: 'Snow returned to the peaks overnight. I drew their silhouette on the back of a tea tin and chose three skeins for today: cloud white, larch bark, summit shadow. The kitchen smells of bergamot.',
      diary_e2_date: 'Late evening',
      ...
      diary_e3_date: 'Knit night',
      diary_e3_text: 'A friend came back to the circle after two years away. She brought her late mother’s needles wrapped in linen. We did not knit much; we listened more.',
      diary_e4_date: 'A Sunday call',
      diary_e4_text: 'A friend called from the farm. The first spring mérinos is being washed. She asked if I wanted the cream or the buttery one. Both, of course. Both, always.',
      diary_e5_date: 'A Sunday sketch',
      diary_e5_text: 'I drew the alpine river from memory while waiting for the kettle. The river never stays the same colour twice in winter — slate, teal, oxblood at noon.',
      diary_e6_date: 'A grey day',
      ...
      diary_e7_date: 'Christmas Eve',
      diary_e7_text: 'I gave a young one in the family the Heather Valley socks. He put them on immediately, shoes too tight after, didn’t care. Best gift returned: his face.',
      diary_e8_date: 'An autumn evening',
      diary_e8_text: 'Tried German short rows again on the alpine shawl. The transition is finally invisible. Twelve years of knitting and a single technique can still humble you. Good.',
      diary_e9_date: 'Reading Sunday',
      ...
      diary_e10_date: 'An evening at the vinothèque',
      diary_e10_text: 'Tasted three local wines with a friend. The dornfelder gave me my next palette: smoky garnet, cracked leather, evening fog.',
      diary_e11_date: 'A heatwave day',
      ...
      diary_e12_date: 'By the alpine lake',
      diary_e12_text: 'Kayak day with a friend. The lake produced exactly the teal I have been looking for since spring. Took a photo, took a yarn cake, both for a wall at home.',
      ...
      atelier_pillar3_text: 'Glarus light dictates my colours — alpine frost in winter, larch gold in autumn, deep teal at dusk.',
      ...
      atelier_studio_title: 'Glimpses of home',
      ...
      atelier_studio_eyebrow: 'Knitting',
      ...
      gallery_hero_eyebrow: 'Full collection · open home',
      ...
      gallery_cat_ponchos_text: 'Earthy silhouettes for the country veranda and the mountain path.',
      ...
      gallery_signature_caption: 'An open home · Glarus, Switzerland',
      bio_about_link: 'About Denise',
      gallery_ext_shawl_mistyteal_title: 'Misty Teal Shawl',
      gallery_ext_caftan_cedar2_title: 'Cedar Vista — Quiet',
      ...
      journal_hero_title_script: 'the attic',
      journal_hero_lede: 'Slow essays on resilience, wool, alpine seasons and the rituals of an open home. Read by the wood stove, with chamomile in hand.',
      ...
      // Contact 2.0
      contact_hero_eyebrow: 'Write to my knitting',
      ...
      contact_subject_visit: 'Visiting in person',
      ...
      contact_channels_title: 'Reach my knitting',
      ...
      contact_channel_knitnight_meta: 'Open hands — bring your needles or simply your tea.',
      ...
      contact_map_eyebrow: 'Find my knitting',
      contact_map_title_main: 'A door in',
      contact_map_title_script: 'Glarus',
      contact_map_lede: 'Tucked in the heart of Glarus, I open my door by gentle appointment. Ring before you ring the bell.',
      contact_faq_eyebrow: 'Quiet questions',
      contact_faq_title: 'Before you write',
      contact_faq1_q: 'Do you sell pieces from the gallery?',
      contact_faq1_a: 'No — the gallery is a sharing space. Pieces remain at my knitting or travel as gifts. If you fall in love with one, write to me; we may find a private way for it to live with you.',
      ...
      contact_faq3_q: 'May I visit my knitting?',
      ...
      contact_faq4_a: 'Within a week, often sooner. My knitting moves at the pace of stitches — never instantly, always sincerely.',
    ...
    fr: {
      ...
      hero_eyebrow: 'Tricotée à la main dans les Alpes · Glaris, Suisse',
      hero_title_main: 'Rangs paisibles, lumière alpine et une',
      hero_title_script: 'seconde vie',
      hero_lede: 'Je suis Denise — tricoteuse de Glaris. Avec le temps et le calme de mon côté, je tresse aujourd’hui laine, souffle et souvenirs.',
      hero_paragraph: 'Ce journal de tricot rassemble mes pièces tricotées main, les techniques que j’aime et les palettes alpines qui guident mes aiguilles. Prenez le temps, suivez le fil, et écrivez-moi librement.',
      hero_cta_gallery: 'Voir la galerie',
      hero_cta_atelier: 'Découvrir le métier',
      hero_signature: 'Denise',
      hero_signature_role: 'Tricoteuse dans les Alpes',
      ...
      slide3_eyebrow: 'Tricot de Glaris · Une invitation',
      slide3_title_main: 'Là où la laine devient',
      slide3_title_script: 'mémoire',
      slide3_lede: 'Au cœur des Alpes Glaronaises, ma maison rassemble la lumière du nord, le poêle à bois et le rythme lent des matins de montagne.',
      slide3_paragraph: 'Entrez pour découvrir les quatre piliers de mon métier et les rituels de tricot que j’aime partager. Ou simplement écrivez-moi — je réponds toujours.',
      slide3_cta_primary: 'Découvrir le métier',
      slide3_cta_secondary: 'Écrire à Denise',
      slide3_signature: 'Glaris',
      slide3_signature_role: 'Une maison ouverte dans les Alpes',
      bio_breadcrumb: 'À propos de Denise',
      bio_eyebrow: 'L’artisane',
      bio_name_first: 'Denise',
      bio_name_last: 'Gillioz',
      bio_kicker: 'tricot de Glaris',
      bio_lede: 'Tricoteuse de Glaris, Suisse.',
      bio_manifesto: 'Pendant de longues années, les obligations professionnelles et la vie de famille ont souvent éloigné mes mains du tricot. Quand la retraite a ouvert la porte, j’ai repris les choses en main. J’ai monté une paire de chaussettes. Je n’ai plus jamais reposé les aiguilles.',
      bio_chap1_eyebrow: 'Chapitre un',
      bio_chap1_title: 'Un tournant',
      bio_chap1_p1: 'Un changement est venu, comme viennent souvent les changements — sans fanfare, mais dans un matin vide. J’ai fait du thé, ouvert les volets sur le froid alpin, et cherché quelque chose à tenir.',
      bio_chap1_p2: 'Les aiguilles sont descendues du grenier — en noyer, polies par des mains bien antérieures aux miennes. J’ai monté vingt mailles et n’ai pas levé les yeux jusqu’au déjeuner. Quelque chose en moi attendait ce silence.',
      bio_chap2_eyebrow: 'Chapitre deux',
      bio_chap2_title: 'La rencontre avec la laine',
      bio_chap2_p1: 'J’avais déjà tricoté — des écharpes pour ma famille, un cardigan, une fois. Mais rencontrer la laine avec le temps de son côté n’est pas la même chose que la rencontrer en hâte un dimanche.',
      bio_chap2_p2: 'J’ai lu ; j’ai écouté des fileuses ; j’ai conduit jusqu’à de petites fermes alpines où des femmes m’ont appris comment le mérinos veut être tenu, pourquoi le bébé alpaga se couche et le mérinos se redresse, ce que le kid mohair fait à la lumière de six heures du soir. La laine m’a appris la patience. La patience m’a appris à dessiner.',
      bio_chap3_eyebrow: 'Chapitre trois',
      bio_chap3_title: 'Où je tricote aujourd’hui',
      bio_chap3_p1: 'Je tricote dans le grenier converti, exposé nord, éclairé par la neige six mois par an. Il y a un poêle à bois que j’entretiens avec soin, un établi d’un autre temps, et un dévidoir vintage chiné en marché aux puces.',
      bio_chap3_p2: 'Je tricote entre le matin et le soir, avec une pause camomille à midi. J’organise un cercle de tricot mensuel à Glaris ; les nouveaux venus reçoivent un thé, un patron et un mot d’accueil manuscrit.',
      bio_chap3_p3: 'Je ne vends pas. Je partage. Je publie des photographies parce que j’aime la palette alpine et veux qu’elle vive ailleurs que dans mes seuls yeux. Ce site n’est pas une boutique — c’est une maison ouverte. Entrez. Restez un peu.',
      ...
      bio_quote_author: 'Denise Gillioz',
      bio_signature: 'Denise',
      bio_signature_caption: 'Glaris · Suisse',
      bio_cta_atelier: 'Découvrir le métier',
      bio_cta_gallery: 'Voir la galerie',
      bio_cta_journal: 'Lire le journal',

      atelier_open_diary: 'Lire les notes de tricot',
      ...
      parallax_cite: 'Denise · dans le calme alpin',
      scroll_cue: 'Découvrir',
      write_tooltip: 'Écrire à Denise',

      rhythm_eyebrow: 'Une journée de tricot',
      rhythm_title: 'Le rythme du tricot',
      rhythm_lede: 'Heure de Glaris, saisons alpines. Le tricot respire à son propre rythme — voici ce qui s’y passe en ce moment.',
      rhythm_phase_dawn: 'Denise allume le poêle à bois et ouvre la fenêtre du nord.',
      rhythm_phase_morning: 'Heures de tricot · mailles lentes dans la lumière froide du matin.',
      rhythm_phase_noon: 'Pause camomille face aux cimes alpines.',
      ...
      rhythm_phase_night: 'La maison dort sous les étoiles alpines.',

      diary_breadcrumb: 'Notes de tricot',
      diary_eyebrow: 'Une pratique en fragments',
      diary_title: 'Les notes de tricot',
      diary_lede: 'Notes courtes du grenier — une trouvaille de fil, une phrase soulignée, un croquis alpin à l’aube. Aucun ordre, seulement la météo.',
      ...
      diary_signature_caption: 'Notes de tricot · mises à jour quand la lumière est juste',
      diary_e1_date: 'Un matin paisible',
      diary_e1_text: 'La neige est revenue sur les cimes pendant la nuit. J’ai dessiné leur silhouette au dos d’une boîte à thé et choisi trois écheveaux pour aujourd’hui : blanc nuage, écorce de mélèze, ombre de sommet. La cuisine sent la bergamote.',
      diary_e2_date: 'Un soir tardif',
      ...
      diary_e3_date: 'Soirée tricot',
      diary_e3_text: 'Une amie est revenue au cercle après deux ans d’absence. Elle a apporté les aiguilles de sa mère, enveloppées dans du lin. Nous n’avons pas beaucoup tricoté ; nous avons surtout écouté.',
      diary_e4_date: 'Un dimanche au téléphone',
      diary_e4_text: 'Une amie a appelé de la ferme. Le premier mérinos de printemps est en cours de lavage. Elle m’a demandé si je voulais le crème ou le beurré. Les deux, bien sûr. Les deux, toujours.',
      diary_e5_date: 'Un croquis dominical',
      diary_e5_text: 'J’ai dessiné la rivière alpine de mémoire en attendant la bouilloire. La rivière ne reste jamais deux fois de la même couleur en hiver — ardoise, teal, sang-de-bœuf à midi.',
      diary_e6_date: 'Une journée grise',
      ...
      diary_e7_date: 'Réveillon de Noël',
      diary_e7_text: 'J’ai offert à un jeune de la famille les chaussettes Heather Valley. Il les a enfilées immédiatement, chaussures trop serrées ensuite, sans s’en plaindre. Plus beau cadeau retourné : son visage.',
      diary_e8_date: 'Un soir d’automne',
      diary_e8_text: 'Réessayé les rangs raccourcis allemands sur le châle alpin. La transition est enfin invisible. Douze ans de tricot et une seule technique sait encore vous humilier. Tant mieux.',
      diary_e9_date: 'Dimanche de lecture',
      ...
      diary_e10_date: 'Une soirée à la vinothèque',
      diary_e10_text: 'Dégusté trois vins locaux avec une amie. Le dornfelder m’a offert ma prochaine palette : grenat fumé, cuir craquelé, brouillard du soir.',
      diary_e11_date: 'Une journée caniculaire',
      ...
      diary_e12_date: 'Au bord du lac alpin',
      diary_e12_text: 'Journée kayak avec une amie. Le lac a produit exactement le teal que je cherchais depuis le printemps. J’ai pris une photo, j’ai pris un écheveau, les deux pour le mur de la maison.',
      hero_stat_pieces_n: '120+',
      ...
      hero_stat_years: 'D’artisanat paisible',
      hero_strip_socks: 'Chaussettes',
      hero_strip_shawls: 'Châles & étoles',
      hero_strip_ponchos: 'Ponchos',
      hero_strip_caftans: 'Caftans',
      atelier_eyebrow: 'Mon métier · Mon approche',
      atelier_title: 'Les fils d’une vie paisible',
      ...
      atelier_pillar3_text: 'La lumière de Glaris dicte mes couleurs — givre alpin en hiver, or des mélèzes en automne, teal profond au crépuscule.',
      ...
      atelier_studio_title: 'Aperçus de la maison',
      ...
      gallery_hero_eyebrow: 'Collection complète · maison ouverte',
      ...
      gallery_cat_ponchos_text: 'Silhouettes terriennes pour la véranda de la maison et le sentier de montagne.',
      ...
      gallery_signature_caption: 'Une maison ouverte · Glaris, Suisse',
      bio_about_link: 'À propos de Denise',
      gallery_ext_shawl_mistyteal_title: 'Châle Teal Brumeux',
      gallery_ext_caftan_cedar2_title: 'Cèdre Vista — Calme',
      ...
      journal_hero_title_script: 'le grenier',
      journal_hero_lede: 'Essais lents sur la résilience, la laine, les saisons alpines et les rituels d’une maison ouverte. À lire près du poêle, une camomille à la main.',
      ...
      // Contact 2.0
      contact_hero_eyebrow: 'Écrire à Denise',
      ...
      contact_subject_visit: 'Une visite en personne',
      ...
      contact_channels_title: 'Joindre Denise',
      ...
      contact_channel_knitnight_meta: 'Tricot ouvert — apportez vos aiguilles ou seulement votre tasse.',
      ...
      contact_map_eyebrow: 'Trouver Denise',
      contact_map_title_main: 'Une porte à',
      contact_map_title_script: 'Glaris',
      contact_map_lede: 'Lové au cœur de Glaris, j’ouvre ma porte sur rendez-vous discret. Sonnez avant de sonner à la porte.',
      ...
      contact_faq1_a: 'Non — la galerie est un espace de partage. Les pièces restent ici ou voyagent en cadeau. Si l’une d’elles vous touche, écrivez-moi ; nous trouverons peut-être un chemin discret pour qu’elle vous accompagne.',
      ...
      contact_faq3_q: 'Puis-je rendre visite à Denise ?',
      ...
      contact_faq4_a: 'Dans la semaine, souvent plus tôt. Mon tricot avance au rythme des mailles — jamais instantané, toujours sincère.',
    ...
    de: {
      ...
      hero_eyebrow: 'Handgestrickt in den Alpen · Glarus, Schweiz',
      hero_title_main: 'Stille Reihen, Alpenlicht und ein',
      hero_title_script: 'zweites Leben',
      hero_lede: 'Ich bin Denise — eine Strickerin aus Glarus. Mit Zeit und Stille auf meiner Seite verflechte ich heute Wolle, Atem und Erinnerungen.',
      hero_paragraph: 'Dieses Stricknotizen versammelt meine handgestrickten Stücke, die Techniken, die ich liebe, und die Alpenpaletten, die meine Nadeln führen. Lassen Sie sich Zeit, folgen Sie dem Faden — und schreiben Sie mir gern.',
      hero_cta_gallery: 'Galerie entdecken',
      hero_cta_atelier: 'Das Handwerk entdecken',
      hero_signature: 'Denise',
      hero_signature_role: 'Strickerin in den Alpen',
      ...
      slide3_eyebrow: 'Glarus Knitting · Eine Einladung',
      slide3_title_main: 'Wo Wolle zu',
      slide3_title_script: 'Erinnerung wird',
      slide3_lede: 'Im Herzen der Glarner Alpen vereint mein Zuhause Nordlicht, Holzofen und den langsamen Rhythmus der Bergmorgen.',
      slide3_paragraph: 'Treten Sie ein, um die vier Säulen meines Handwerks und die Strick-Rituale zu entdecken, die ich gerne teile. Oder schreiben Sie mir einfach — ich antworte immer.',
      slide3_cta_primary: 'Das Handwerk entdecken',
      slide3_cta_secondary: 'An Denise schreiben',
      slide3_signature: 'Glarus',
      slide3_signature_role: 'Ein offenes Zuhause in den Alpen',
      bio_breadcrumb: 'Über Denise',
      bio_eyebrow: 'Die Macherin',
      bio_name_first: 'Denise',
      bio_name_last: 'Gillioz',
      bio_kicker: 'tricot de Glaris',
      bio_lede: 'Eine Strickerin aus Glarus, Schweiz.',
      bio_manifesto: 'Lange Jahre haben berufliche Pflichten und das Familienleben meine Hände oft vom Stricken ferngehalten. Als die Pensionierung die Tür öffnete, nahm ich die Dinge wieder in die Hand. Ich schlug ein Paar Socken an. Seither habe ich die Nadeln nicht mehr aus der Hand gelegt.',
      bio_chap1_eyebrow: 'Erstes Kapitel',
      bio_chap1_title: 'Eine Wende',
      bio_chap1_p1: 'Eine Veränderung kam, wie Veränderungen oft kommen — nicht mit Fanfaren, sondern mit einem leeren Morgen. Ich kochte Tee, öffnete die Fenster auf die alpine Kälte und suchte nach etwas, das ich halten konnte.',
      bio_chap1_p2: 'Die Nadeln kamen vom Dachboden — aus Walnussholz, glatt geworden durch Hände lange vor den meinen. Ich schlug zwanzig Maschen an und blickte nicht auf bis zum Mittag. Etwas in mir hatte auf diese Stille gewartet.',
      bio_chap2_eyebrow: 'Zweites Kapitel',
      bio_chap2_title: 'Die Begegnung mit der Wolle',
      bio_chap2_p1: 'Ich hatte schon gestrickt — Schals für meine Familie, einen Cardigan einmal. Doch der Wolle mit Zeit auf seiner Seite zu begegnen ist nicht dasselbe wie in einem hastigen Sonntagshobby.',
      bio_chap2_p2: 'Ich las; ich hörte Spinnerinnen zu; ich fuhr zu kleinen alpinen Höfen, wo Frauen mir lehrten, wie Merinofasern gehalten werden wollen, warum Babyalpaka liegt und Merino aufspringt, was Kid-Mohair um sechs Uhr abends mit dem Licht macht. Die Wolle lehrte mich Geduld. Geduld lehrte mich zu entwerfen.',
      bio_chap3_eyebrow: 'Drittes Kapitel',
      bio_chap3_title: 'Wo ich heute stricke',
      bio_chap3_p1: 'Ich stricke im umgebauten Dachboden zu Hause, nordwärts ausgerichtet, sechs Monate im Jahr vom Schnee erleuchtet. Da ist ein Holzofen, den ich behutsam pflege, ein Werktisch aus einer anderen Zeit und ein Vintage-Spuler vom Flohmarkt.',
      bio_chap3_p2: 'Ich stricke zwischen Morgen und Abend, mit einer Kamillenpause am Mittag. Ich richte einen monatlichen Strickkreis in Glarus aus; Neuankommende erhalten Tee, ein Muster und eine handgeschriebene Begrüßung.',
      bio_chap3_p3: 'Ich verkaufe nicht. Ich teile. Ich poste Fotografien, weil ich die Alpenpalette liebe und sie anderswo leben lassen möchte als nur in meinen eigenen Augen. Diese Seite ist kein Laden — sie ist ein offenes Zuhause. Treten Sie ein. Bleiben Sie eine Weile.',
      ...
      bio_quote_author: 'Denise Gillioz',
      bio_signature: 'Denise',
      bio_signature_caption: 'Glarus · Schweiz',
      bio_cta_atelier: 'Das Handwerk entdecken',
      bio_cta_gallery: 'Galerie ansehen',
      bio_cta_journal: 'Journal lesen',

      atelier_open_diary: 'Stricknotizen lesen',
      ...
      parallax_cite: 'Denise · in der alpinen Stille',
      scroll_cue: 'Entdecken',
      write_tooltip: 'An Denise schreiben',

      rhythm_eyebrow: 'Ein Tag mit Stricken',
      rhythm_title: 'Der Rhythmus des Strickens',
      rhythm_lede: 'Glarner Zeit, alpine Jahreszeiten. Das Stricken atmet nach seinem eigenen Takt — hier ist, was gerade geschieht.',
      rhythm_phase_dawn: 'Denise zündet den Holzofen an und öffnet das Nordfenster.',
      rhythm_phase_morning: 'Strickstunden · langsame Maschen im kalten Morgenlicht.',
      rhythm_phase_noon: 'Kamillenpause mit Blick auf die alpinen Gipfel.',
      ...
      rhythm_phase_night: 'Das Zuhause schläft unter alpinen Sternen.',

      diary_breadcrumb: 'Stricknotizen',
      diary_eyebrow: 'Eine Praxis in Fragmenten',
      diary_title: 'Das Stricknotizen',
      diary_lede: 'Kurze Notizen aus dem Dachboden — ein Wollfund, ein unterstrichener Satz, eine alpine Skizze im Morgengrauen. Keine Ordnung, nur Wetter.',
      ...
      diary_signature_caption: 'Stricknotizen · aktualisiert, wenn das Licht stimmt',
      diary_e1_date: 'Ein stiller Morgen',
      diary_e1_text: 'Über Nacht kehrte Schnee auf die Gipfel zurück. Ich zeichnete ihre Silhouette auf die Rückseite einer Teedose und wählte drei Stränge für heute: Wolkenweiß, Lärchenrinde, Gipfelschatten. Die Küche riecht nach Bergamotte.',
      diary_e2_date: 'Spätes Abendlicht',
      ...
      diary_e3_date: 'Strickabend',
      diary_e3_text: 'Eine Freundin kam nach zwei Jahren Abwesenheit zurück in den Kreis. Sie brachte die Nadeln ihrer verstorbenen Mutter, in Leinen gewickelt. Wir strickten wenig; wir hörten mehr zu.',
      diary_e4_date: 'Ein Sonntagsanruf',
      diary_e4_text: 'Eine Freundin rief vom Hof an. Das erste Frühlings-Merino wird gewaschen. Sie fragte, ob ich das Cremefarbene oder das Butterige wolle. Beide, natürlich. Beide, immer.',
      diary_e5_date: 'Eine sonntägliche Skizze',
      diary_e5_text: 'Ich zeichnete den alpinen Fluss aus dem Gedächtnis, während der Kessel heiß wurde. Der Fluss bleibt im Winter nie zweimal dieselbe Farbe — Schiefer, Teal, Ochsenblut am Mittag.',
      diary_e6_date: 'Ein grauer Tag',
      ...
      diary_e7_date: 'Heiligabend',
      diary_e7_text: 'Ich schenkte einem jungen Familienmitglied die Heather-Valley-Socken. Er zog sie sofort an, danach saßen die Schuhe zu eng, das war ihm egal. Bestes erwidertes Geschenk: sein Gesicht.',
      diary_e8_date: 'Ein Herbstabend',
      diary_e8_text: 'Habe deutsche Kurzreihen am alpinen Schal noch einmal versucht. Der Übergang ist endlich unsichtbar. Zwölf Jahre Stricken, und eine einzige Technik kann einen noch demütigen. Gut so.',
      diary_e9_date: 'Lesesonntag',
      ...
      diary_e10_date: 'Ein Abend in der Vinothek',
      diary_e10_text: 'Drei lokale Weine mit einer Freundin probiert. Der Dornfelder schenkte mir meine nächste Palette: rauchiger Granat, gerissenes Leder, Abendnebel.',
      diary_e11_date: 'Ein Hitzetag',
      ...
      diary_e12_date: 'Am alpinen See',
      diary_e12_text: 'Kajaktag mit einer Freundin. Der See ergab genau das Teal, das ich seit dem Frühling suchte. Ich nahm ein Foto, ich nahm einen Wollknäuel — beides für eine Wand zu Hause.',
      hero_stat_pieces_n: '120+',
      ...
      hero_stat_years: 'Im stillen Handwerk',
      hero_strip_socks: 'Socken',
      hero_strip_shawls: 'Schals & Stolen',
      hero_strip_ponchos: 'Ponchos',
      hero_strip_caftans: 'Kaftane',
      atelier_eyebrow: 'Mein Handwerk · Mein Ansatz',
      atelier_title: 'Fäden eines stillen Lebens',
      ...
      atelier_pillar3_text: 'Das Glarner Licht bestimmt meine Farben — alpiner Frost im Winter, Lärchengold im Herbst, tiefes Teal in der Dämmerung.',
      ...
      atelier_studio_title: 'Einblicke ins Zuhause',
      ...
      gallery_hero_eyebrow: 'Gesamtkollektion · offenes Zuhause',
      ...
      gallery_cat_ponchos_text: 'Erdige Silhouetten für die Hausveranda und den Bergweg.',
      ...
      gallery_signature_caption: 'Ein offenes Zuhause · Glarus, Schweiz',
      bio_about_link: 'Über Denise',
      gallery_ext_shawl_mistyteal_title: 'Nebelteal-Schal',
      gallery_ext_caftan_cedar2_title: 'Zedernblick — Stille',
      ...
      journal_hero_title_script: 'der Dachboden',
      journal_hero_lede: 'Langsame Essays über Resilienz, Wolle, Alpenjahreszeiten und die Rituale eines offenen Zuhauses. Am Holzofen zu lesen, mit Kamillentee in der Hand.',
      ...
      blog_card4_date_long: '18. November 2023',
      // Contact 2.0
      contact_hero_eyebrow: 'An Denise schreiben',
      ...
      contact_subject_visit: 'Denise besuchen',
      ...
      contact_channels_title: 'Denise erreichen',
      ...
      contact_channel_knitnight_meta: 'Offene Einladung — bringen Sie Ihre Nadeln oder einfach Ihren Tee.',
      ...
      contact_map_eyebrow: 'Denise finden',
      contact_map_title_main: 'Eine Tür in',
      contact_map_title_script: 'Glarus',
      contact_map_lede: 'Eingebettet im Herzen von Glarus öffne ich meine Tür auf sanfte Verabredung. Klingeln Sie, bevor Sie an der Tür klingeln.',
      ...
      contact_faq1_a: 'Nein — die Galerie ist ein Ort des Teilens. Die Stücke bleiben hier oder reisen als Geschenk. Wenn Sie sich in eines verlieben, schreiben Sie mir; vielleicht finden wir einen leisen Weg, es bei Ihnen wohnen zu lassen.',
      ...
      contact_faq3_q: 'Darf ich Denise besuchen?',
      ...
      contact_faq4_a: 'Innerhalb einer Woche, oft früher. Mein Stricken bewegt sich im Tempo der Maschen — niemals sofort, immer aufrichtig.',
  ...
  var ARTICLE_HINTS = {
    ...
    ponchos: [9, 8],       // Behind the knitting + Alpine Horizons
    caftans: [9, 7],       // Behind the knitting + Wool & Wellness
    mittens: [9, 6]
  };
  var ARTICLE_META = {
  ...
  var SLUG_MAP = {
    ...
    14: 'piece-alpine-vista-shawl',
    15: 'piece-alpine-river-wrap',
    16: 'piece-mountain-breeze-throw',
  ...
  var TITLE_MAP = {
    home: 'Hand-knit wool from the Glarus knitting',
    gallery: 'Gallery',
    atelier: 'Craft',
    diary: 'Knitting notes',
    about: 'About Denise',
    journal: 'Journal',
    contact: 'Contact',
    ...
    'article-studio': 'Behind the knitting',
    ...
    'piece-alpine-vista-shawl': 'Alpine Vista Shawl',
    'piece-alpine-river-wrap': 'Alpine River Wrap',
    'piece-mountain-breeze-throw': 'Mountain Breeze Throw',
  ...
  // -----------------------------------------------------------
  // Knitting notes — tag filtering with smooth empty-state
  // -----------------------------------------------------------
  ...
  // -----------------------------------------------------------
  // Rhythm at home — analog clock + time-aware status
  //   Glarus is Europe/Zurich. We use Intl with that timezone
  //   so the rhythm reflects local time, not the visitor's.
  // -----------------------------------------------------------
  var RHYTHM_PHASES = [
  ...
  var ARTICLE_PIECES = {
    ...
    9: [18, 25, 26, 27]    // Behind the knitting → ponchos + caftans
  };
