...
var translations = {
  "en": {
    ...
    "home_intro_2": "This lite showcase shares highlights from Denise’s home, weaving stories of resilience, lifestyle rituals, and the beauty of crafted wool.",
    ...
    "about_intro_1": "I am Denise Gillioz, a Swiss knitter. Time and quiet have given me room to slow down with wool and share what I make.",
    ...
    "blog_heading": "Notes from Denise",
    "blog_intro": "Explore how knitting supports wellbeing, the lessons drawn from Swiss landscapes, and the quiet rituals I love to share with newcomers.",
    "blog_card1_meta": "05 Feb 2024 • Knitting notes",
    ...
    "blog_card4_title": "Behind the knitting",
    "blog_card4_excerpt": "Morning rituals, playlists, and dye pots that keep my knitting humming.",
    ...
    "article1_sidebar_paragraph1": "Handspun Swiss merino held with baby alpaca on 4.5 mm wooden needles, palette inspired by alpine dawns.",
    ...
    "article3_lede": "Some designs begin with silence. I take the train into the alpine quiet, sketching peaks as sunrise spills over the valley.",
    "article3_section1_heading": "Colour notes from the valley",
    "article3_paragraph_1": "Frosted meadows offer silvery sage, while alpine streams gift deep teal. I capture each hue in a palette notebook before it fades.",
    ...
    "article3_paragraph_2": "A lightweight camera, an audio recorder of cowbells, and a pouch of swatches travel with me so ideas return home unhurried.",
    ...
    "article3_sidebar_item1": "Alpine river overlook – teal & slate for gradient socks.",
    "article3_sidebar_item2": "Mountain pine forest – moss green with copper flecks.",
    ...
    "article3_sidebar_paragraph": "Planning a sunrise sketch session by an alpine lake with thermos chai and a basket of fresh swatches.",
    "article4_tag": "Behind the Scenes",
    "article4_title": "Behind the knitting",
    "article4_hero_intro": "A look at the routines that keep my Glarus knitting vibrant and welcoming.",
    "article4_meta_date": "18 Nov 2023",
    "article4_meta_read": "5 min read",
    "article4_lede": "My home wakes at first light when I open the shutters to watch pink light brush the alpine peaks.",
    ...
    "article4_callout_heading": "Knitting rhythms",
    ...
    "article4_paragraph_2": "Time on my side means I can move slowly; I listen to the weather and let it decide whether I dye, design, or simply mend.",
    "article4_paragraph_3": "This rhythm keeps my mind clear and reminds me that craft is a companion, not a race.",
    "article4_sidebar_heading": "Knitting essentials",
    "article4_sidebar_item1": "Maple worktable built by my father.",
    "article4_sidebar_item2": "Vintage swift rescued from a flea market.",
    ...
    "article4_sidebar_paragraph": "I host a monthly knit circle in Glarus; newcomers receive tea, pattern notes, and a hug at the door.",
    ...
    "gallery12_related_blog": "See behind the knitting →",
    ...
    "gallery14_title": "Alpine Vista Shawl",
    ...
    "gallery15_title": "Alpine River Wrap",
    ...
    "gallery16_title": "Mountain Breeze Throw",
    "gallery16_intro": "Chunky alpine throw inspired by the breeze that rolls over an alpine lake.",
    ...
    "gallery16_color4": "Natural Cream",
    "gallery16_related_blog": "See behind the knitting →",
    ...
    "gallery18_intro": "Draped poncho glowing with the evening lights of the alpine valley.",
    ...
    "gallery18_related_blog": "See behind the knitting →",
    ...
    "gallery21_intro": "Gradient stripes capturing alpine sunrise.",
    ...
    "gallery27_intro": "Flowing caftan tailored for cedar forests and quiet days.",
    ...
    "blog_filter_all": "All",
    "blog_filter_studio": "Knitting notes",
    ...
    "gallery_cap_glaernisch_vista": "Alpine Vista Shawl",
    "gallery_cap_linth_wrap": "Alpine River Wrap",
    "gallery_cap_kloental_breeze": "Mountain Breeze Throw",
  ...
  "fr": {
    ...
    "home_intro_2": "Cette version allégée présente quelques pièces de Denise, tissant résilience, rituels de bien-être et beauté laineuse.",
    ...
    "gallery_extended_heading": "Vitrine étendue",
    ...
    "about_intro_1": "Je suis Denise Gillioz, tricoteuse en Suisse. Le temps et le calme me laissent l’espace de ralentir avec la laine et de partager ce que je fais.",
    ...
    "blog_heading": "Récits de l’tricot de Glaris",
    ...
    "blog_card1_meta": "05 fév. 2024 • Notes de tricot",
    ...
    "blog_card4_title": "Coulisses du tricot",
    "blog_card4_excerpt": "Rituels matinaux, playlists et cuves de teinture qui animent le tricot.",
    ...
    "article1_sidebar_paragraph1": "Mérinos suisse filé main associé à de l’alpaga bébé sur aiguilles en bois 4,5 mm, palette inspirée des aubes alpines.",
    ...
    "article3_lede": "Certains modèles naissent du silence. Je monte dans le train vers le calme alpin en esquissant les sommets que le soleil touche.",
    "article3_section1_heading": "Notes de couleur de la vallée",
    "article3_paragraph_1": "Les prés givrés offrent un sauge argenté, tandis que les torrents alpins apportent un bleu profond. J’inscris chaque teinte dans un carnet avant qu’elle ne s’efface.",
    ...
    "article3_paragraph_2": "Un appareil photo léger, un enregistrement de cloches de vaches et une pochette d’échantillons m’accompagnent pour que les idées rentrent à la maison sans précipitation.",
    ...
    "article3_sidebar_item1": "Belvédère sur une rivière alpine – bleu sarcelle et ardoise pour des chaussettes dégradées.",
    "article3_sidebar_item2": "Forêt de pins en montagne – vert mousse et éclats cuivrés.",
    ...
    "article3_sidebar_paragraph": "Prévoir une session d’esquisses à l’aube au bord d’un lac alpin avec thermos de chai et panier d’échantillons.",
    "article4_tag": "Dans les coulisses",
    "article4_title": "Coulisses du tricot",
    "article4_hero_intro": "Un regard sur les routines qui gardent ma maison à Glaris vibrant et accueillant.",
    "article4_meta_date": "18 nov. 2023",
    "article4_meta_read": "Lecture de 5 min",
    "article4_lede": "La maison s’éveille aux premières lueurs lorsque j’ouvre les volets pour regarder la lumière rose caresser les cimes alpines.",
    ...
    "article4_callout_heading": "Rythmes de tricot",
    ...
    "article4_paragraph_2": "Le temps de mon côté me permet de bouger lentement ; j’écoute la météo et la laisse décider si je teins, dessine ou répare simplement.",
    "article4_paragraph_3": "Ce rythme clarifie mon esprit et me rappelle que l’artisanat est un compagnon, non une course.",
    "article4_sidebar_heading": "Essentiels de tricot",
    ...
    "article4_sidebar_paragraph": "J’anime un cercle de tricot mensuel à Glaris ; les nouveaux reçoivent du thé, des notes de patrons et une accolade à l’entrée.",
    ...
    "gallery12_related_blog": "Entrer dans « Coulisses du tricot » →",
    ...
    "gallery14_title": "Châle Panorama Alpin",
    ...
    "gallery15_title": "Étole Rivière Alpine",
    "gallery15_intro": "Étole rectangulaire qui évoque les courants et reflets d’hiver d’une rivière alpine.",
    ...
    "gallery16_title": "Plaid Brise des Montagnes",
    "gallery16_intro": "Plaid épais pour les soirées tranquilles, inspiré des vents d’un lac alpin.",
    ...
    "gallery16_color4": "Crème naturelle",
    "gallery16_related_blog": "Entrer dans « Coulisses du tricot » →",
    ...
    "gallery18_intro": "Poncho drapé qui rayonne des lumières du soir d’une vallée alpine.",
    ...
    "gallery18_related_blog": "Entrer dans « Coulisses du tricot » →",
    ...
    "gallery21_intro": "Rayures dégradées capturant l’aube alpine.",
    ...
    "gallery27_intro": "Caftan fluide pensé pour les forêts de cèdres et les journées calmes.",
    ...
    "blog_filter_studio": "Notes de tricot",
    ...
    "gallery_cap_glaernisch_vista": "Châle Panorama Alpin",
    "gallery_cap_linth_wrap": "Étole Rivière Alpine",
    "gallery_cap_kloental_breeze": "Plaid Brise des Montagnes",
  ...
  "de": {
    ...
    "home_intro_2": "Diese Lite-Version zeigt ausgewählte Stücke von Denise und verknüpft Resilienz, Lebensstilrituale und die Schönheit von Wolle.",
    ...
    "gallery_extended_heading": "Erweiterte Galerie",
    ...
    "about_intro_1": "Ich bin Denise Gillioz, eine Schweizer Strickerin. Zeit und Stille geben mir Raum, mit Wolle innezuhalten und das Gemachte zu teilen.",
    ...
    "blog_heading": "Notizen von Denise",
    ...
    "blog_card1_meta": "05. Feb. 2024 • Stricknotizen",
    ...
    "blog_card4_title": "Hinter den Maschen",
    "blog_card4_excerpt": "Morgenrituale, Playlists und Färbetöpfe, die mein Stricken lebendig halten.",
    ...
    "article1_sidebar_paragraph1": "Handgesponnene Schweizer Merinowolle mit Babyalpaka auf 4,5-mm-Holznadeln, Palette inspiriert von alpinen Morgen.",
    ...
    "article3_lede": "Manche Entwürfe beginnen im Schweigen. Ich nehme den Zug in die alpine Stille und skizziere Gipfel, während die Sonne das Tal berührt.",
    "article3_section1_heading": "Farbnotizen aus dem Tal",
    "article3_paragraph_1": "Bereifte Wiesen schenken silbriges Salbei, alpine Bäche tiefes Petrol. Ich halte jede Nuance im Paletten-Tagebuch fest, bevor sie verblasst.",
    ...
    "article3_paragraph_2": "Eine leichte Kamera, Tonaufnahmen von Kuhglocken und ein Etui mit Maschenproben begleiten mich, damit Ideen ungestört nach Hause zurückkehren.",
    ...
    "article3_sidebar_item1": "Aussicht über einen alpinen Fluss – Petrol & Schiefer für Verlaufssocken.",
    "article3_sidebar_item2": "Bergwald – Moosgrün mit Kupferschimmer.",
    ...
    "article3_sidebar_paragraph": "Geplant ist eine Skizzensession zum Sonnenaufgang an einem alpinen See mit Thermos-Chai und einem Korb voller Proben.",
    "article4_tag": "Hinter den Kulissen",
    "article4_title": "Hinter den Maschen",
    "article4_hero_intro": "Ein Blick auf die Routinen, die mein Glarner Stricken lebendig und offen halten.",
    "article4_meta_date": "18. Nov. 2023",
    "article4_meta_read": "Lesezeit 5 Min.",
    "article4_lede": "Mein Zuhause erwacht im ersten Licht, wenn ich die Fensterläden öffne und rosa Licht die alpinen Gipfel berührt.",
    ...
    "article4_callout_heading": "Strick-Rhythmen",
    ...
    "article4_sidebar_heading": "Strick-Essentials",
    ...
    "article4_sidebar_paragraph": "Ich veranstalte einen monatlichen Strickkreis in Glarus; neue Gesichter erhalten Tee, Musternotizen und eine Umarmung an der Tür.",
    ...
    "gallery12_related_blog": "„Hinter den Maschen“ besuchen →",
    ...
    "gallery14_title": "Alpiner Panoramaschal",
    ...
    "gallery15_title": "Alpine Flussstola",
    ...
    "gallery16_title": "Berg-Brise-Throw",
    "gallery16_intro": "Kuscheliger alpiner Throw, inspiriert von der Brise über einem alpinen See.",
    ...
    "gallery16_color4": "Natürliches Creme",
    "gallery16_related_blog": "„Hinter den Maschen“ besuchen →",
    ...
    "gallery18_intro": "Locker fallender Poncho, der mit den Abendlichtern eines alpinen Tals schimmert.",
    ...
    "gallery18_related_blog": "„Hinter den Maschen“ besuchen →",
    ...
    "gallery21_intro": "Farbverläufe, die den alpinen Sonnenaufgang einfangen.",
    ...
    "gallery27_intro": "Fließender Kaftan für Zedernwälder und ruhige Tage.",
    ...
    "blog_filter_studio": "Stricknotizen",
    ...
    "gallery_cap_glaernisch_vista": "Alpiner Panoramaschal",
    "gallery_cap_linth_wrap": "Alpine Flussstola",
    "gallery_cap_kloental_breeze": "Berg-Brise-Throw",
